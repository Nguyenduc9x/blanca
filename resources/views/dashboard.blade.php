      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="index.html">
            <img src="FrontEnd/Admin/images/logo.svg" alt="logo">
          </a>
          <a class="navbar-brand brand-logo-mini" href="index.html">
            <img src="FrontEnd/Admin/images/logo-mini.svg" alt="logo">
          </a>
        </div>
      </div>
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="FrontEnd/Admin/images/faces/face8.jpg" alt="Profile image"> </a>
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              <li class="list active">
                <div class="profile"><img src="FrontEnd/Admin/images/faces/face1.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Thomas Douglas</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="FrontEnd/Admin/images/faces/face2.jpg" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="FrontEnd/Admin/images/faces/face3.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Daniel Russell</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="FrontEnd/Admin/images/faces/face4.jpg" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="FrontEnd/Admin/images/faces/face5.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="FrontEnd/Admin/images/faces/face6.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Sarah Graves</p>
                  <p>Available</p>
                </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="FrontEnd/Admin/pages/forms/basic_elements.html">Basic Elements</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="FrontEnd/Admin/pages/charts/chartjs.html">ChartJs</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="FrontEnd/Admin/pages/tables/basic-table.html">Basic table</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="FrontEnd/Admin/pages/icons/mdi.html">Mdi icons</a></li>
              </ul>
            </div>
          </li>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <div class="chartjs-bar-wrapper mt-3"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                  <canvas id="marketingOverview" width="1003" height="150" style="display: block; width: 1003px; height: 150px;" class="chartjs-render-monitor"></canvas>
                                </div>
                              </div>
                            </div>
                          </div>
                              ...
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-lg-12"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                    ...
                                    <canvas class="my-auto chartjs-render-monitor" id="doughnutChart" height="308" width="463" style="display: block; width: 463px; height: 308px;"></canvas>
                                ...
                                <div class="row">
                                  <div class="col-lg-12">
                                    ...
                                    <div class="mt-3"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                      <canvas id="leaveReport" width="463" height="150" style="display: block; width: 463px; height: 150px;" class="chartjs-render-monitor"></canvas>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-12">
                                    ...
                                    <div class="mt-3">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="FrontEnd/Admin/images/faces/face3.jpg" alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="FrontEnd/Admin/images/faces/face4.jpg" alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="FrontEnd/Admin/images/faces/face5.jpg" alt="profile">
                                          <div class="wrapper ms-3">
