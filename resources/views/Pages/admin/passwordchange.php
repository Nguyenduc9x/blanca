...
<head>
  ...
  <link rel="stylesheet" href="FrontEnd/changepassword.css">
  <!-- endinject -->
...
<body>
  <div class="container-scroller">
    <!-- partial:FrontEnd/Admin/partials/_navbar.html -->
        ...
        <div class="navbar-menu-wrapper d-flex align-items-top"> 
          <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
              <h1 class="welcome-text">Xin chào, <span class="text-black fw-bold">Name author</span></h1>
            </li>
          </ul>
    ...
    <div class="container-fluid page-body-wrapper">
      <!-- partial:FrontEnd/Admin/partials/_settings-panel.html -->
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/pages/ui-features/buttons.html">Account information</a></li>
                <li class="nav-item"> <a class="nav-link" href="/passwordchange">Change Password</a></li>
                <li class="nav-item"> <a class="nav-link" href="/pages/ui-features/typography.html">User maganer</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="/pages/forms/basic_elements.html">All post</a></li>
                <li class="nav-item"><a class="nav-link" href="/pages/forms/basic_elements.html">Add new</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/pages/charts/chartjs.html">Add/delete</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/pages/tables/basic-table.html">All Comment</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/pages/icons/mdi.html">All contact</a></li>
              </ul>
            </div>
          </li>
        </ul>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="container">
            <div class="row">
              <div id="change-password" class="col-md-6 col-md-offset-3" >
                <div class="panel panel-primary">
                  <div class="panel-heading">Change Password</div>
                  <div class="panel-body">
                    <form action="{{route('password-change')}}">
                      <div class="form-group">
                        <label for="exampleInputPassword1">New Password</label>
                        <input type="password" class="form-control" id="newpw" placeholder="Password" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Repeat New Password</label>
                        <input type="password" class="form-control" id="repeatnewpw" placeholder="Password" required>
                      </div>
